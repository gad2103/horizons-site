...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocalizedLocation.address'
        db.alter_column('location_localizedlocation', 'address', self.gf('tinymce.models.HTMLField')())

    def backwards(self, orm):

        # Changing field 'LocalizedLocation.address'
        db.alter_column('location_localizedlocation', 'address', self.gf('django.db.models.fields.CharField')(max_length=127))
