...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LocalizedBanner.title'
        db.delete_column('banner_localizedbanner', 'title')


        # Changing field 'LocalizedBanner.description'
        db.alter_column('banner_localizedbanner', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=127))

    def backwards(self, orm):
        # Adding field 'LocalizedBanner.title'
        db.add_column('banner_localizedbanner', 'title',
