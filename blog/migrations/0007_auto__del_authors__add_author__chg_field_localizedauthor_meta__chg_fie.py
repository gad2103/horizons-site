...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocalizedAuthor.meta'
        db.alter_column('blog_localizedauthor', 'meta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Author']))

        # Changing field 'Blog.created_by'
        db.alter_column('blog_blog', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Author'], null=True))
    ...
    def backwards(self, orm):
        ...
        db.create_table('blog_authors', (
            ...
            ('node_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['node.Node'], unique=True, primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['auth.User'], blank=True)),
        ))
        ...
        # Changing field 'LocalizedAuthor.meta'
        db.alter_column('blog_localizedauthor', 'meta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Authors']))

        # Changing field 'Blog.created_by'
        db.alter_column('blog_blog', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Authors'], null=True))
    ...
    models = {
        ...
        'blog.author': {
            'Meta': {'object_name': 'Author', '_ormbases': ['node.Node']},
        ...
        'blog.blog': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Author']", 'null': 'True', 'blank': 'True'}),
            'node_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['node.Node']", 'unique': 'True', 'primary_key': 'True'}),
            'picture': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        'blog.localizedauthor': {
            ...
            'meta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Author']"})
        },
        'blog.localizedblog': {
