...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalizedTestimonial.exerpt'
        db.add_column('testimonial_localizedtestimonial', 'exerpt',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocalizedTestimonial.exerpt'
        db.delete_column('testimonial_localizedtestimonial', 'exerpt')
    ...
    models = {
        ...
        'testimonial.localizedtestimonial': {
            ...
            'exerpt': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
