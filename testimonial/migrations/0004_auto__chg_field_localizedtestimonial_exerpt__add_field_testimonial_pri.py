...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocalizedTestimonial.exerpt'
        db.alter_column('testimonial_localizedtestimonial', 'exerpt', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
        # Adding field 'Testimonial.priority'
        db.add_column('testimonial_testimonial', 'priority',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'LocalizedTestimonial.exerpt'
        db.alter_column('testimonial_localizedtestimonial', 'exerpt', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
        # Deleting field 'Testimonial.priority'
        db.delete_column('testimonial_testimonial', 'priority')
    ...
    models = {
        ...
        'testimonial.localizedtestimonial': {
            ...
            'author': ('django.db.models.fields.CharField', [], {'max_length': '127', 'null': 'True', 'blank': 'True'}),
