...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Inthenews.exerp'
        db.rename_column('inthenews_inthenews', 'exerp', 'exerpt')


    def backwards(self, orm):

        # Renaming field 'Inthenews.exerpt'
        db.rename_column('inthenews_inthenews', 'exerpt', 'exerp')
    ...
    models = {
        ...
        'inthenews.inthenews': {
            ...
            'exerpt': ('tinymce.models.HTMLField', [], {'null': 'True', 'blank': 'True'}),
