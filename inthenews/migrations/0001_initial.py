...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Inthenews'
        db.create_table('inthenews_inthenews', (
            ...
            ('source', self.gf('django.db.models.fields.CharField')(max_length=63)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=63)),
            ('exerp', self.gf('tinymce.models.HTMLField')(null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('inthenews', ['Inthenews'])


    def backwards(self, orm):
        # Deleting model 'Inthenews'
        db.delete_table('inthenews_inthenews')
    ...
    models = {
        ...
        'inthenews.inthenews': {
            'Meta': {'object_name': 'Inthenews', '_ormbases': ['node.Node']},
            'exerp': ('tinymce.models.HTMLField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'source': ('django.db.models.fields.CharField', [], {'max_length': '63'}),
