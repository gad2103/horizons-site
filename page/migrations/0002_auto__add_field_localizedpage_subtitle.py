...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalizedPage.subtitle'
        db.add_column('page_localizedpage', 'subtitle',
                      self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocalizedPage.subtitle'
        db.delete_column('page_localizedpage', 'subtitle')
