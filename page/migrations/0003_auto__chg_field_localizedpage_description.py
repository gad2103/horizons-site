...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocalizedPage.description'
        db.alter_column('page_localizedpage', 'description', self.gf('tinymce.models.HTMLField')(null=True))

    def backwards(self, orm):

        # Changing field 'LocalizedPage.description'
        db.alter_column('page_localizedpage', 'description', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'page.localizedpage': {
            ...
            'subtitle': ('django.db.models.fields.CharField', [], {'max_length': '127', 'null': 'True', 'blank': 'True'}),
