...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('course_class', 'code', self.gf('django.db.models.fields.CharField')(default=0, max_length=31))

    def backwards(self, orm):

        # Changing field 'Class.code'
        db.alter_column('course_class', 'code', self.gf('django.db.models.fields.CharField')(max_length=31, null=True))
