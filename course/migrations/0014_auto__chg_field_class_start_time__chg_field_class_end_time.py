...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Class.start_time'
        db.alter_column('course_class', 'start_time', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Class.end_time'
        db.alter_column('course_class', 'end_time', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Class.start_time'
        db.alter_column('course_class', 'start_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Class.end_time'
        db.alter_column('course_class', 'end_time', self.gf('django.db.models.fields.DateTimeField')())
