...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocalizedTargetCategory.language'
        db.add_column('course_localizedtargetcategory', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=12, related_name='portal localization language', to=orm['node.Language']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocalizedTargetCategory.language'
        db.delete_column('course_localizedtargetcategory', 'language_id')
