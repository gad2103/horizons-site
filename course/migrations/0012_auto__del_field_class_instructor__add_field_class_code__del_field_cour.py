...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Class.instructor'
        db.delete_column('course_class', 'instructor_id')

        # Adding field 'Class.code'
        db.add_column('course_class', 'code',
    ...
    def backwards(self, orm):
        # Adding field 'Class.instructor'
        db.add_column('course_class', 'instructor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['instructor.Instructor'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Class.code'
        db.delete_column('course_class', 'code')
