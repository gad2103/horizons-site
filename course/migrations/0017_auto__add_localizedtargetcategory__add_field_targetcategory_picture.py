...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocalizedTargetCategory'
        db.create_table('course_localizedtargetcategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['course.TargetCategory'])),
            ('intro', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('course', ['LocalizedTargetCategory'])

        # Adding field 'TargetCategory.picture'
        db.add_column('course_targetcategory', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LocalizedTargetCategory'
        db.delete_table('course_localizedtargetcategory')

        # Deleting field 'TargetCategory.picture'
        db.delete_column('course_targetcategory', 'picture')
