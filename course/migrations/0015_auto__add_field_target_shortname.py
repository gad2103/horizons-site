...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Target.shortname'
        db.add_column('course_target', 'shortname',
                      self.gf('django.db.models.fields.CharField')(default='TBD', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Target.shortname'
        db.delete_column('course_target', 'shortname')
