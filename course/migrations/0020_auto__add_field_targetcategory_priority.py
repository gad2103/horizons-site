...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TargetCategory.priority'
        db.add_column('course_targetcategory', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default='1000'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TargetCategory.priority'
        db.delete_column('course_targetcategory', 'priority')
