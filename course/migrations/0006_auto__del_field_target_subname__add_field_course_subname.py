...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Target.subname'
        db.delete_column('course_target', 'subname')

        # Adding field 'Course.subname'
        db.add_column('course_course', 'subname',
                      self.gf('django.db.models.fields.CharField')(max_length=63, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Target.subname'
        db.add_column('course_target', 'subname',
                      self.gf('django.db.models.fields.CharField')(max_length=31, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Course.subname'
        db.delete_column('course_course', 'subname')
    ...
    models = {
        ...
        'course.course': {
            ...
            'node_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['node.Node']", 'unique': 'True', 'primary_key': 'True'}),
            'subname': ('django.db.models.fields.CharField', [], {'max_length': '63', 'null': 'True', 'blank': 'True'}),
