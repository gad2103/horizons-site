...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Weblink.priority'
        db.add_column('course_weblink', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default='1000'),
                      keep_default=False)

        # Adding field 'Class.priority'
        db.add_column('course_class', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default='1000'),
                      keep_default=False)

        # Adding field 'Course.priority'
        db.add_column('course_course', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default='1000'),
                      keep_default=False)

        # Adding field 'Target.priority'
        db.add_column('course_target', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default='1000'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Weblink.priority'
        db.delete_column('course_weblink', 'priority')

        # Deleting field 'Class.priority'
        db.delete_column('course_class', 'priority')

        # Deleting field 'Course.priority'
        db.delete_column('course_course', 'priority')

        # Deleting field 'Target.priority'
        db.delete_column('course_target', 'priority')
    ...
    models = {
        ...
        'course.class': {
            'Meta': {'ordering': "['-priority']", 'object_name': 'Class', '_ormbases': ['node.Node']},
