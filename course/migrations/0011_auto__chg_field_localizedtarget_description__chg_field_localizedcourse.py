...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LocalizedTarget.description'
        db.alter_column('course_localizedtarget', 'description', self.gf('tinymce.models.HTMLField')(null=True))

        # Changing field 'LocalizedCourse.description'
        db.alter_column('course_localizedcourse', 'description', self.gf('tinymce.models.HTMLField')(null=True))

    def backwards(self, orm):

        # Changing field 'LocalizedTarget.description'
        db.alter_column('course_localizedtarget', 'description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'LocalizedCourse.description'
        db.alter_column('course_localizedcourse', 'description', self.gf('django.db.models.fields.TextField')(null=True))
