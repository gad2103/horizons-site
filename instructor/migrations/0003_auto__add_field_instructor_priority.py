...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instructor.priority'
        db.add_column('instructor_instructor', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default='1000'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instructor.priority'
        db.delete_column('instructor_instructor', 'priority')
